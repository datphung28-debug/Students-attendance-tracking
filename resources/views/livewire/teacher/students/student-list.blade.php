                        ...
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-neutral-700">
                            ...
                            <tbody class="divide-y divide-gray-200 dark:divide-neutral-700">
                                ...
                                <tr :key="{{ $student->id }}">
                                    ...
                                    <td class="h-px w-auto whitespace-nowrap">
                                        <div class="px-6 py-2">
                                            <span class="text-sm text-gray-800 dark:text-neutral-200">{{$student->age}}
                                            </span>
                                    ...
                                    <td class="h-px w-auto whitespace-nowrap px-6 py-2">
                                        <div class="flex gap-1">
                                            ...
                                            <a href="/edit/student/{{$student->id}}"
                                                class="flex justify-center items-center size-9.5 rounded-lg bg-blue-600 text-white hover:bg-blue-700">
                                            ...
                                            <button type="button" wire:click="delete({{ $student->id }})"
                                                class="flex justify-center items-center size-9.5 rounded-lg bg-red-500 text-white hover:bg-red-600">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
